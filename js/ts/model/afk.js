...
export { Beasts, Branch, Heroes, RelicManager, Renderer, TierManager as Tier, based, classes, defaults, races, baseRelics as relicLeveling, stored, townTypes, };
class TierManager {
    static next(id) {
