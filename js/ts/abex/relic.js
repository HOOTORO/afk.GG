...
export function runRelic() {
    ...
    const userInput = createElementN("div", { class: "ui-input" }, "Essence & Captured Towns"), ess = createInput("number", "", aeIcons.ess, {
    ...
    [5, 6, 7, 8].forEach((x) => {
        ...
        const input = createInput("number", ``, `/assets/ae/ranks/icon_level${x}.png`, {
            min: "0",
            max: "40",
