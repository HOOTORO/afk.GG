...
_[TS]: сокр. от Treasure Scramble
_[LC]: сокр. от Legends Championship, тот самый китовый раздел арены героев
_[CR]: сокр. от Cursed Realm, Проклятый Мир, Курса...
_[TL;DR]: англ. Too Long, Don't Read  
_[Q&A]: aнгл. Questions & Answer. Секция вопросов и ответов
_[F2P]: англ. Free To Play. Игрок, не закинувший в игру ни копейки
_[low_spender]: Игрок с минильным донатным набором
_[PTS]: сокр. от Points, Очки, Поинты
_[кап]: Максимально доступное значение
_[WR]: англ. Winrate. Соотношение побед к поражениям
...
!!! note Глоссарий
    ...
    Выбирается в начале сезона из 3ех вариантов: ![routes_trns](images/routes.png)
    ...
    ![brack](images/brackets_small.png) Ромбы под текущей лигой, как раз показывают бракет.
    - **Stat buff** - Бафф Дивизиона, снижается по ходу сезона
    ![stbuff](images/buff.png) в последнем дивизионе (Master) **отсутствует**
...
| Регионы глобала              | Дивизионы                 |
| ---------------------------- | ------------------------- |
| ![a](images/regions.png)     |                           |
| ![f](images/divstatbuff.png) | ![p](images/brackets.png) |

| Эмблема                           | Название  | PTS                      |
| --------------------------------- | --------- | ------------------------ |
| ![r](images/icon_rank_1_smol.png) | Rookie    | 1000                     |
| ![r](images/icon_rank_2_smol.png) | Inititate | 2000                     |
| ![r](images/icon_rank_3_smol.png) | Adept     | 3000                     |
| ![r](images/icon_rank_4_smol.png) | Veteran   | 4000                     |
| ![r](images/icon_rank_5_smol.png) | Expert    | 5000                     |
| ![r](images/icon_rank_6_smol.png) | Master    | 6000                     |
| ![r](images/icon_rank_7_smol.png) | Champion  | Секретная лига[^suspect] |
...
<div class="tbl" style="overflow-x:auto;">
    <table id="sc" cellspacing="0">
        ...
        <tbody>
            <tr>
                <td><img src="images/alteam.png" alt="alt"></td>
                <td><img src="images/tkapa.png" alt="kappa"></td>
            </tr>
            <tr>
                <td><img src="images/ph.png" alt="phantom" class="small"></td>
                <td><img src="images/thg.png" alt="mine"></td>
            </tr>
        </tbody>
        <tfoot>
        <tr>
...
<div class="tbl" style="overflow-x:auto;">
    <table id="routeclimb" cellspacing="0">
        ...
        <tbody>
            <tr>
                <td><img src="images/ptty.png" alt="alt"></td>
                <td><img src="images/meh.png" alt="kappa"></td>
            </tr>
        </tbody>
        <tfoot>
        <tr>
