...
!!! note Глоссарий
    ...
    Выбирается в начале сезона из 3ех вариантов: ![routes_trns](/assets/img/routes.png)
    ...
    ![brack](/assets/img/brackets_small.png) Ромбы под текущей лигой, как раз показывают бракет.
    - **Stat buff** - Бафф Дивизиона, снижается по ходу сезона
    ![stbuff](/assets/img/buff.png) в последнем дивизионе (Master) **отсутствует**
...
<div class="tbl" style="overflow-x:auto;">
    <table id="regional-info" cellspacing="0">
        ...
        <tbody>
            <tr>
                <td colspan=1><img src="/assets/img/regions.png" alt="regi" /></td>
                <td>
                    <table id="divisions" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                <td><img src="/assets/img/afk/icon_rank_1_smol.png" alt="rook" /></td>
                                <td><strong>Rookie</strong></td>
                                <td><em>1000 pts</em></td>
                            </tr>
                            <tr>
                                <td><img src="/assets/img/afk/icon_rank_2_smol.png" alt="init" /></td>
                                <td><strong>Inititate</strong></td>
                                <td><em>2000 pts</em></td>
                            </tr>
                            <tr>
                                <td><img src="/assets/img/afk/icon_rank_3_smol.png" alt="ad" /></td>
                                <td><strong>Adept</strong></td>
                                <td><em>3000 pts</em></td>
                            </tr>
                            <tr>
                                <td><img src="/assets/img/afk/icon_rank_4_smol.png" alt="vet" /></td>
                                <td><strong>Veteran</strong></td>
                                <td><em>4000 pts</em></td>
                            </tr>
                            <tr>
                                <td><img src="/assets/img/afk/icon_rank_5_smol.png" alt="exp" /></td>
                                <td><strong>Expert</strong></td>
                                <td><em>5000 pts</em></td>
                            </tr>
                            <tr>
                                <td><img src="/assets/img/afk/icon_rank_6_smol.png" alt="masta" /></td>
                                <td><strong>Master</strong></td>
                                <td><em>6000 pts</em></td>
                            </tr>
                            <tr>
                                <td><img src="/assets/img/afk/icon_rank_7_smol.png" alt="secret"  /></td>
            ...
            <tr>
                <td><img src="/assets/img/divstatbuff.png" alt="nolck" /></td>
                <td><img src="/assets/img/brackets.png" alt="nolck" /></td>
            </tr>
        </tbody>
        <tfoot>
        <tr>
...
<div class="tbl" style="overflow-x:auto;">
    <table id="sc" cellspacing="0">
        ...
        <tbody>
            <tr>
                <td><img src="/assets/img/alteam.png" alt="alt"></td>
                <td><img src="/assets/img/tkapa.png" alt="kappa"></td>
            </tr>
            <tr>
                <td><img src="/assets/img/ph.png" alt="phantom" class="small"></td>
                <td><img src="/assets/img/thg.png" alt="mine"></td>
            </tr>
        </tbody>
        <tfoot>
        <tr>
...
<div class="tbl" style="overflow-x:auto;">
    <table id="routeclimb" cellspacing="0">
        ...
        <tbody>
            <tr>
                <td><img src="/assets/img/ptty.png" alt="alt"></td>
                <td><img src="/assets/img/meh.png" alt="kappa"></td>
            </tr>
        </tbody>
        <tfoot>
        <tr>
