...
В администрации мамонты обожающие поиграть в "я здесь власть!", уровень интеллекта - _директор колхоза_ хамоватые и неблагодарные, в общении личности не приятные в общем.
///
////
<!-- prettier-ignore -->
/// admonition | Общепризнанный вклад в развитие сообщества
