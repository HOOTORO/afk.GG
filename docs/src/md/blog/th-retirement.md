...
Все мои “_нападки_” на трафа, были исключительно на сообщения, в которых содержалась **ложная**/**саботирующая** *
*гильдию** информация  
...
![YqdUhIK][porq2]{ .resized }
![MAeUkD5][porq3]{ .resized }
...
![invisible speak][porq4]{ .resized }
![invisible speak][porq5]{ .resized }
![invisible speak][porq6]{ .resized }
![invisible speak][porq7]{ .resized }
...
![PcIKJqt][porq8]{ .resized }
![eteUqXy][porq9]{ .resized }
...
![P0HiCbY][porq15]{ .resized }
![tw146Td][porq16]{ .resized }
...
![sss][porq17]{ .resized }
![9GVP8qG][porq18]{ .resized }
![CiuJkPi][porq19]{ .resized }
![dOa90Ni][porq20]{ .resized }
...
<figure markdown>
![1iTIPFq][porq22]{ .resized }
   <figcaption>
      Close enough!  
   </figcaption>
</figure>
<figure markdown>
![HdGL1XB][porq23]{ .resized }
![C8lPQUj][porq24]{ .resized }
   <figcaption>
...
![6YhBv9p][porq25]{ .resized }
![PMC fan][porq26]{ .resized }
![67G9PDr][porq27]{ .resized }
![guidelines][guidelines]{ .resized }
...
![6HnmSDl][porq31]{ .resized }
![no response][porq32]{ .resized }
...
![LFApj4f][porq35]{ .resized }
![kis][porq36]{ .resized }
![9P760fY][porq37]{ .resized }
...
![J0oSYGp][porq38]{ .resized }
![dh5wgiR][porq39]{ .resized }
![P0j35aE][porq40]{ .resized }
...
| ![ru][iogr]{width=350}               | ![mDFn2B8][iog2th]{width=400} |
|--------------------------------------|-----------------------------|
...
<figure markdown>
![IOG-advices][meanwhilehosp]{ .resized }
   <figcaption>
...
![qQxNRrV][dm8]{ .resized }
![Om9KF3H][dm9]{ .resized }
![J99dtL4][dm10]{ .resized }
![L44wgLB][dm11]{ .resized }
![LJv7bbI][dm12]{ .resized }
![Z0ubF2b][dm13]{ .resized }
![ae][dm14]{ .resized }
...
??? warning "`Заслуги трафарета в последнее время:`"
...
<figure markdown>
![YlzSOe4][dm20]{ .resized }
   <figcaption>
      Надежды на спокойный уход не оправдались
   </figcaption>
</figure>
<figure markdown>
![d1IMmKy][dm21]{ .resized }
   <figcaption>
      тихо шифером шурша…  
   </figcaption>
</figure>
...
5. В случае благоприятного исхода, участие в руководящем совете CASUALS планировалось смотреть в зависимости от
   итогового количества перешедших людей[^ppl].
...
[^ppl]: Заочно ожидалось 30-40 чел, но учитывая что в ги никто не знал об этих планах. И никаких гарантий и тем более
...
![afterS8][aeafter]{ .resized }
![afters81][aeafter1]{ .resized }
![afters82][ae2]{ .resized }
![afters83][ae3]{ .resized }
![afters84][ae4]{ .resized }
![afters86][ae5]{ .resized }
...
|-------------------------|----------------------------|
| ![wtf these names][cha] | ![goldenporka][cha2]       |
