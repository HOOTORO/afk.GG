...
Более развернуто о вреде такого роде спекуляци ниже. 
...
Просто посмотрев на цифры, невозможно не заметить крайне уверенный перфоманс Аквы. Если в S9 это была тотальная доминация NM на всех фронтах, то в S10 невооруженным взглядом видно насолько высокий средний показатель по акве в целом, что явно намекает на то что очень много людей отлично поработали, постаравшись выжать максимум из акков (ну или что на всех акках отыгрывала небольшая группа людей :D ).
А вот гляда на средние показатели Хурриканов, ума не приложу, по каких сусекам там Винтер наскребла урона что бы вырвать второе место. Рискну предположить, что в ги имеются явные проблемы с координацией/мотивацией состава и как следствие много ошибок, предположительно многих пришлось вытаскивать на пробитие с вилами и факелами.
