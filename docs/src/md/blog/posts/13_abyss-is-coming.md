...
<!-- # AbEx Incoming :material-alert-decagram:{ .mdx-pulse title="Added on July 9, 2024" } -->

В преддверии старта тестовой бездны.
Спешу поделиться ^^организационной структурой^^ черных. Расписал более детально и наглядно, для самых юных. А то согласно некоторой обратной связи, прошлой отсылки к армейским структурам, оказалось недостаточно.
<!-- more -->
...
Но стоит провести мысленный эксперимент, поставим в аналогичную ситуацию случайного человека. Каковы шансы угадывать желания трафарета в слепую и что произойдет когда случится проблема в которой неизбежно увидят связь с ним, при том что у него 0 представления того где он сделал и что не так?
Что печальней всего в такой ситуации определенная доля людей придет к выводу:  
> "А оно мне надо?"  
...
**Зачем это нужно?:** Текущая специфика бездны такова, что **тестировать и оптимизировать построения надо всем**, хотя бы свои основные. (8)  
...
Может быть стоит задуматься о создании отдельного дискорда под бездну ![kappa]{width=32}
...
- Tactical Unit, Спец. Единица Разведки
    ...
    Задача: Мониторинг открытых источников по бездне (Crowdsource, Reddit и т.д. список предоставим)
- Branch Officer 
    Позывной: _БРО, брат, братан, братишка_
    Необходимо: 4 чел
    Задача: Сопровождение группы СОф, на протяжение бездны, сбор и передача актуальноЙ информации в тактическое звено.
- Squad Officer, Сезонный Куратор Актива 
    Позывной: _СОСКА_
    Необходимо: 12 чел
    Задача: Сопровождение группы игроков(4-5 игроков) на протяжении всего сезона бездны. Сбор актуальных данных в своей группе и своевременная передача БРО.
...
Которая открывает доступ к каналу с тестами построений. При наличии желания и времени, будет круто если поделитель результатами там!
...
Хочется верить что этот пост, поможет в будущем избежать аналогичного публичного конфуза ![kappa]{width=32}
