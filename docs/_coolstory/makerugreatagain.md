...
- **релевантность**, легко найти ответ на вопрос зачем и как реализует свою функцию правило
- **комфортными**, должны быть созданы условия, в которых следование правилам, естественно и не вызывает отторжения. Неприемлемы окружающие условия подталкивающие к/провоцирующие нарушению/е правил[^badrules].
- **беспристрастными**, конечно едины для всех, перед законом или все равны или никто.

Плохие же, обычно либо для галочки висят, или используются для решения сиюминутных задач (прим: получение персональных выгод).
