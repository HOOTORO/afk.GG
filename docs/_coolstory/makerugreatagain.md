...
Шансы появления человека с свежим взглядом, который осознает в чем сила и сплотит Кхаласар, покроет весь мир и т.д. всегда есть.
А пока на гмах клованы с дешевыми трюками, можно не переживать за позиции НМа.

---

Мой уход, это в первую очередь уход из СНГ сообщества.  
_Основная тема поста:_   
<font style="font-size:30px;">**Токсичность и безысходность ру сообществах**</font>  
давно воспринимается как норма. Периодическое вываливание негатива прикрытого сарказмом в сторону игры или соги не такая уж редкость.  
...
АФК арена не может похвастать полнотой документации игровых механик/режимов игры. А сама игра обладает достаточно большим набором разнообразных(в т.ч. нелинейно зависимых) атрибутов и механик, оказывающих разного рода влияние на результат в том или ином игровом режиме.
...
В рунете не имелось регулярно обновляемых ресурсов с реддит-переводами на тот момент, гуляли разве что кустарные.
...
Если классифицировать эти источники инфы по специфике:
 ...
 - TIER: <a style="color:red">THE BAD.</a>  
  ВК/ТГ чаты, качество - КОТ В МЕШКЕ, доступность - ПОМОЙКА. Обусловлено спонтанностью явления и отсутствием адекватной модерации. Ценность сомнительная, не рассматривается в этом тексте.
...
- TIER: <a style="color:brown">THE UGLY.</a>    
  Discord - В виду того что это всегда было местом обитания наиболее мотивированной части игроков нацеленных на внутриигровые достижения в том или ином виде. Появилась тенденция, что если реддита/говно чатов мало, то за более качественной узкопрофильной инфой милости прошу в дискорд.  
  Однако соревновательная направленность накладывала свой отпечаток. Не всем такое надо. Рассмотрим подробнее ниже.
- TIER: <a style="color:cyan">GOD.</a>  
  Китайские форумы. Уровень доступный лишь просвещенным. Сам китайского не знаю и единственное что могу сказать, несмотря на то что потенциально там может быть наиболее углубленная и точная инфа, если **лично вы** не владеете языком, то к инфе отсылающейся на такой источник стоит относиться максимально осторожно, потому что есть вероятность что автор тоже не владеет :D. Хотелось бы, хоть одним глазком, но тоже вне целей данного текста.
...
[Список дискорд-серверов](../dis.md) по АФК тематике в списке перечислены известные мне крупные открытые сервера с наиболее актуальной информацией. Так же есть один весьма популярный, но закрытый(то есть инвайт можно получить только у кого-то знакомого с администрацией сервера) Push Friends.  
...
Ключевое различие, которое влияет и на контент и  администрирования сервера, банально цель и причина существования заложенная при создании.
...
- Основная цель независимого сервера с обозначенной тематикой: _Сбор и анализ_ максимально полных данных по теме и поиск наиболее оптимальных стратегий в сопутствующей тематике.

Каким образом это может и непременно влияет на производимый контент и модерацию сервера?
В случае с гильдией немаловажный аспект это сохранение стратегически важной информации непосредственно связанной с гильдейскими активностями и формирование устойчивых отношений внутри гильдии для максимально эффективного взаимодействия во время событий.
